...
import com.dvulovic.ppmtool.services.CustomUserDetailsService;

import static com.dvulovic.ppmtool.security.SecurityConstants.SIGN_UP_URLS;
import static com.dvulovic.ppmtool.security.SecurityConstants.H2_URL;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(AuthenticationManagerBuilder authMgrBuilder) throws Exception {
		authMgrBuilder.userDetailsService(customUserDetailsService).passwordEncoder(bCryptPasswordEncoder);
	}
